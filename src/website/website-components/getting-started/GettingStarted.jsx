    ...
    <div className="  pt-32 ">
      <div className="getting-started-text translate-y-10 text-center w-full  overflow-hidden opacity-0">
        <div className=" font-semibold relative ">
          <h2 className=" anton-font text-[200px] tracking-widest step-running-text break-keep">
        GETTING STARTED
          </h2>
        </div>
      </div>
      ...
      <div className="chatcircle-cards flex flex-c w-full flex-nowrap items-center">
        ...
        <div className="chatcircle-card container-2 h-[80vh]">
            <div className="cc-card-items">
              ...
              />
              <svg width="1066" height="688" className="absolute top-[-18px] left-[-10px]" viewBox="0 0 1066 688" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path id='float-path-2' fill-rule="evenodd" clip-rule="evenodd" d="M560 14.0001C686 -17.5 928.121 5.74625 1014.5 94.0003C1135.41 201.549 1006.5 597 973.131 636.058C920.183 719.77 654.593 623.945 530.365 663.086C412.458 700.234 256.451 693.867 149.72 645.63C96.5632 623.106 50.2291 595.362 19.4747 486.496C-11.0131 378.575 -15.0237 167.859 96.5632 98.8747C197.666 36.3721 426.029 47.4929 560 14.0001Z" />
              </svg>
            </div>
          </div>
        ...
        <div className="cc-card-screen cc-card-screen-3">
          ...
          <div className="chatcircle-card container-3 h-[80vh]">
            <div className="cc-card-items">
              ...
              />
              <svg width="1066" height="688" className="absolute top-[-18px] left-[-10px]" viewBox="0 0 1066 688" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path id='float-path-3' fill-rule="evenodd" clip-rule="evenodd" d="M560 14.0001C686 -17.5 928.121 5.74625 1014.5 94.0003C1135.41 201.549 1006.5 597 973.131 636.058C920.183 719.77 654.593 623.945 530.365 663.086C412.458 700.234 256.451 693.867 149.72 645.63C96.5632 623.106 50.2291 595.362 19.4747 486.496C-11.0131 378.575 -15.0237 167.859 96.5632 98.8747C197.666 36.3721 426.029 47.4929 560 14.0001Z" />
              </svg>
            </div>

      ...
      <div className="chatcircle-cards md:flex w-full flex-nowrap items-center">
        <div className="cc-card-screen cc-card-screen-1 ">
          <div className="w-[100vw] items-center  overflow-x-clip justify-center flex  ">
            <div className="chatcircle-card  container-1 xl:max-w-[1024px] lg:max-w-[800px] md:max-w-[400px] max-w-[300px]">
        ...
        <div className="cc-card-screen">
          <div className="w-[100vw] items-center  overflow-x-clip justify-center flex">
            <div className="chatcircle-card  container-2  xl:max-w-[1024px] lg:max-w-[800px] md:max-w-[400px] max-w-[300px]">
              <div className="cc-card-items p-4 lg:gap-12 xl:p-16 flex flex-col lg:flex-row">
        ...
        <div className="cc-card-screen cc-card-screen-3">
          <div className="w-[100vw] items-center  overflow-x-clip justify-center flex">
            <div className="chatcircle-card container-3 xl:max-w-[1024px] lg:max-w-[800px] md:max-w-[400px] max-w-[300px]">
              <div className="cc-card-items p-4  lg:gap-12 xl:p-16 flex flex-col lg:flex-row">

  ...
  return (
    <div className=" py-10  flex w-full max-w-[940px] items-center flex-col h-[90vh] px-10 xl:px-4 ">
       <form 
          ...
          className=" search-room-bar mb-3  rounded-[30px] items-center py-[12px] pl-8  flex "
        >
          ...
          <input
            ...
            type="text"
            className=" pl-2  bg-transparent w-full outline-none placeholder:text-[#595959] text-[#c9c9c9] placeholder:tracking-[1.5px] placeholder:font-medium placeholder:text-[1rem] text-[1rem]"
          />
          {/* <button
            type="submit"

            ...
            <div className=" h-full py-8 px-10   ">
              <form action="" id='create-room-form' method="post" className='flex flex-col gap-[33px]'>
                <div>
                  ...
                  <input type="text" spellCheck='false' className=' w-full rounded mt-2 ' id='username' placeholder='Enter username...' />
                </div>
                <div>
                  <label htmlFor="password">
                    Password
                  </label>
                  <input type="text" spellCheck='false' className=' w-full rounded mt-2 ' id='password' placeholder='Enter password...' />
                </div>
                ...
                <div>
                  ...
                  <input type="text" spellCheck='false' className=' w-full rounded mt-2 ' id='confirm-password' placeholder='Enter password...' />
                </div>
              </form>
            </div>
